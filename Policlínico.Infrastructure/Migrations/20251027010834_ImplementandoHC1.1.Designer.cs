...
namespace Policlínico.Infrastructure.Migrations
{
    ...
    [Migration("20251027010834_ImplementandoHC1.1")]
    partial class ImplementandoHC11
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Policlínico.Domain.Entities.MovimientoMedicamentoConsulta", b =>
                {
                    b.Property<int>("IdMovimientoConsulta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_movimiento_consulta");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdMovimientoConsulta"));
                    ...
                    b.HasKey("IdMovimientoConsulta");

                    b.HasIndex("ConsultaId");

                    b.HasIndex("DepartamentoId");

                    b.ToTable("MovimientosMedicamentosConsultas");
                });

            modelBuilder.Entity("Policlínico.Domain.Entities.MovimientoMedicamentoConsultaDetalle", b =>
                {
                    b.Property<int>("IdDetalleMovimientoConsulta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_detalle_movimiento_consulta");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdDetalleMovimientoConsulta"));
                    ...
                    b.Property<int>("MovimientoConsultaId")
                        .HasColumnType("integer")
                        .HasColumnName("movimiento_consulta_id");

                    b.HasKey("IdDetalleMovimientoConsulta");

                    b.HasIndex("MedicamentoId");

                    b.HasIndex("MovimientoConsultaId");

                    b.ToTable("MovimientosMedicamentosConsultasDetalles");
                });
            ...
            modelBuilder.Entity("Policlínico.Domain.Entities.PedidoConsulta", b =>
                {
                    b.Property<int>("IdPedidoConsulta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_pedido_consulta");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdPedidoConsulta"));
                    ...
                    b.HasKey("IdPedidoConsulta");

                    b.HasIndex("ConsultaId");

                    b.HasIndex("DepartamentoId");

                    b.ToTable("PedidosConsulta");
                });
            ...
            modelBuilder.Entity("Policlínico.Domain.Entities.PedidoConsultaDetalle", b =>
                {
                    b.Property<int>("IdDetalle")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_detalle_pedido_consulta");
                    ...
                    b.Property<int>("PedidoConsultaId")
                        .HasColumnType("integer")
                        .HasColumnName("pedido_consulta_id");

                    b.HasKey("IdDetalle");

                    b.HasIndex("MedicamentoId");

                    b.HasIndex("PedidoConsultaId");
            ...
            modelBuilder.Entity("Policlínico.Domain.Entities.MovimientoMedicamentoConsultaDetalle", b =>
                {
                    ...
                    b.HasOne("Policlínico.Domain.Entities.MovimientoMedicamentoConsulta", "Movimiento")
                        .WithMany("Detalles")
                        .HasForeignKey("MovimientoConsultaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Policlínico.Domain.Entities.PedidoConsultaDetalle", b =>
                {
                    ...
                    b.HasOne("Policlínico.Domain.Entities.PedidoConsulta", "PedidoConsulta")
                        .WithMany("Detalles")
                        .HasForeignKey("PedidoConsultaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Medicamento");

                    b.Navigation("PedidoConsulta");
                });
